...
- **`../LIDAR_SNOW_INTEGRATION.md`** - Documentation complète LIDAR
...
2. Consulter la documentation LIDAR : `LIDAR_SNOW_INTEGRATION.md`
3. Tester les endpoints : `curl http://localhost:8000/health/`
